...
def dbConnection():
    try:
        connection = pymysql.connect(host="localhost", user="root", password="root", database="speciesclass2",port=3307)
        return connection
    except:
...
url = "https://api.thingspeak.com/channels/2381718/fields/1.json?results=2"
